$(function() {
    var shopId = 1;
    var listUrl = '/schoolshop/shop/listshopauthmapsbyshop?pageIndex=1&pageSize=9999&shopId=' + shopId;
    var deleteUrl = '/schoolshop/shop/removeshopauthmap';
    ...
    $('.shopauth-wrap').on('click', 'a', function (e) {
        ...
        if (target.hasClass('edit')) {
            window.location.href = '/schoolshop/shop/shopauthedit?shopauthId=' + e.currentTarget.dataset.authId;
    ...
    // $('#new').click(function () {
    //     window.location.href = '/schoolshop/shop/shopauthedit';
    // });
});