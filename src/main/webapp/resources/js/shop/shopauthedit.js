$(function() {
	...
	shopAuthId = 1;
	var infoUrl = '/schoolshop/shop/getshopauthmapbyid?shopAuthId=' + shopAuthId;

	var shopAuthPostUrl = '/schoolshop/shop/modifyshopauthmap';

	if (shopAuthId) {
		getInfo(shopAuthId);
	} else {
		$.toast('用户不存在！');
		window.location.href = '/schoolshop/shop/shopmanage';
	}
